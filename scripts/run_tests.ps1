...
g++ -o ez.exe src/main.cpp src/Lexer.cpp src/Parser.cpp src/Interpreter.cpp src/Builtins.cpp src/GUIBuiltins.cpp src/GC.cpp src/GCObject.cpp src/runtime/Builtins_IO.cpp src/runtime/Builtins_Math.cpp src/runtime/Builtins_Net.cpp src/runtime/Builtins_DB.cpp src/runtime/Builtins_String.cpp src/runtime/Builtins_Data.cpp src/runtime/Builtins_PDF.cpp src/runtime/Builtins_Sys.cpp -lws2_32 -lsqlite3 -lcurl -lpthread -ldwmapi -luxtheme -lgdi32 -luser32 -lcomdlg32 -lcomctl32 -lcrypt32 -lole32
