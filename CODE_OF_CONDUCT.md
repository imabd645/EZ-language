...
EZ community a harassment-free experience for everyone, regardless of age, body
...
requests, discussions, and the repository itself), and also applies when an
individual is officially representing the project in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the maintainer via a private channel — open a
[GitHub Security Advisory](https://github.com/imabd645/EZ-language/security/advisories/new)
or contact the maintainer directly through their GitHub profile if the report
does not involve a security issue. All complaints will be reviewed and
